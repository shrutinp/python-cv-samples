...
def calibrate_gauge(gauge_number, file_type):
    ...
    img = cv2.imread('analog-gauge-reader\images\gauge-2.jpg')
    height, width ,ht= img.shape
...
def main():
    ...
    print("1234567890-",min_angle, max_angle, min_value, 6, units, x, y, r )

    #feed an image (or frame) to get the current value, based on the calibration, by default uses same image as calibration
    img = cv2.imread('analog-gauge-reader\images\gauge-1.jpg')
